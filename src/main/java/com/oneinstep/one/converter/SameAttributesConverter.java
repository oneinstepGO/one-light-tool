package com.hst.bss.light.converter;
 ...
 * 如果需要属性名映射，请按如下方式进行属性映射:
 * <pre>
 *     <pre>@Mapper(componentModel = "spring") </pre>
 *     public interface MyConvert {
 *
 *         <pre>@Mapping(source = "id", target = "uid") </pre>
 *         <pre>@Mapping(source = "name", target = "nick") </pre>
 *         B a2B(A a);
 *
 *         List<B> listA2ListB(List<A> list);
 *     }
 * </pre>
 *
 * @author aaron.shaw
