package com.hst.bss.light.redis;

import com.hst.arch.components.exception.types.HSTPromptingBaseException;
import com.hst.bss.light.utils.SpringBeanUtil;
 ...
 *     redisson:
 *       enable: true
 *       nodeAddress: hsbss-masstable-midd.hszq8.com:26457
 *       masterConnectionPoolSize: 300
 *       slaveConnectionPoolSize: 500
 *       connectTimeout: 10000
 * 或者自行注入RedissonClient客户端。
 * <pre>
 * <pre>@Configuration</pre>
 * public class RedissonConfig {
 *
 *     <pre>@NacosValue("${redis.common.clusters:hsbss-masstable-midd.hszq8.com:26457}")</pre>
 ...
 *                 .addNodeAddress("redis://" + redisClusters)
...
public class DistributedLockUtil {
     ...
     * 默认的最大锁等待时间
     */
    public static final long DEFAULT_MAX_WAIT_LOCK_TIME_MS = 100;
    /**
     * 限制可设置的最大的最大锁等待时间
     * 避免长时间阻塞线程
     */
    ...
    public static <T> T tryLockAndSupply(@Valid @NotNull(message = "lockName can't be null.") String lockName, Long waitTime, Supplier<T> supplier) throws InterruptedException {
        ...
        try {
            ...
            if (!result) {
                ...
                throw new HSTPromptingBaseException("10000010", "Can't get the distributed lock.");
            }
