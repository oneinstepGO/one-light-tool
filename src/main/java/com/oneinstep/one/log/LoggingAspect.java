package com.hst.bss.light.log.aop;

import com.hst.arch.components.exception.AbstractHSTBaseException;
import com.hst.bss.light.log.annotation.Logging;
import com.hst.bss.light.log.enums.PrintLogLevel;
import com.hst.bss.light.log.strategy.DynamicLogStrategy;
...
public class LoggingAspect {
    ...
    @Pointcut("@annotation(com.hst.bss.light.log.annotation.Logging)")
            ...
            try {
                ...
                if (throwable == null) {
                    ...
                    if (annotation.printError()) {
                        if (throwable instanceof AbstractHSTBaseException) {
                            AbstractHSTBaseException hstBaseException = (AbstractHSTBaseException) throwable;
                            log.error("[Exiting]: [{}] with error, code={}, msg={}, cost: {} ms", path, hstBaseException.code(), hstBaseException.msg(), time);
                        } else {
