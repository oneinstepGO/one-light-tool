...
public class PageConverter {
     ...
     * @return 分页对象
     */
    public static <T> PageData<T> convert(PageData<?> sourcePage, ListQueryExecute<T> listQuery) {
        PageData<T> targetPage = copyWithoutData(sourcePage);
        ...
        if (targetPage.getNeedTotalCount()) {
     ...
     * @return 拷贝结果
     */
    public static <S, T> PageData<T> copyWithoutData(PageData<S> sourcePage) {
        ...
        if (sourcePage != null) {
            ...
            targetPage.setNeedData(sourcePage.getNeedData());
            targetPage.setNeedTotalCount(sourcePage.getNeedTotalCount());
