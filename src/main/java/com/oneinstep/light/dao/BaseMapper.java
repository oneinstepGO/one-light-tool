...
import static com.oneinstep.light.dao.PageScrollQuery.OrderEnum.ASC;
import static com.oneinstep.light.dao.PageScrollQuery.OrderEnum.DESC;
...
public interface BaseMapper<D, Q> {
     ...
     * @return 数据列表
     */
    default PageData<D> pageByQuery(PageData<?> page, Q q) {
