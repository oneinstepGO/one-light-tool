    ...
    public void startEngine(@Valid @NotNull AsyncTaskContext context, ExecutorService executorService) {
        ...
        try {
            ...
            try {
                ...
                if (cause instanceof LightBaseException) {
                    throw (LightBaseException) cause;
                }
        ...
        return taskIdsArr.stream().map(taskId -> {
            ...
            try {
                if (StringUtils.isBlank(taskClassName)) {
                    ...
                    throw new LightBaseException("bss.light.wrong.taskClassName", "wrong taskClassName");
                }
                ...
                throw new LightBaseException("bss.light.instantiation.task.error", "CREATE TASK: " + taskClassName + " ERROR");
            }
